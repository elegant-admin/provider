...
return [
    ...
    'no_disk'                => 'Disk [:disk] not configured, please add a disk config in `:file`',
    'menus_title_help'       => 'The title supports multiple languages and can be directly the key to the translated file',
    //
