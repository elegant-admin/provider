...
@section('content')
    <section class="content-header">
        <h1>
            {!! $header ?: admin_trans('title') !!}
            <small>{!! $description ?: admin_trans('description') !!}</small>
        </h1>

        <!-- breadcrumb start -->
        @if ($breadcrumb)
        <ol class="breadcrumb">
            <li><a href="{{ admin_url('/') }}"><i class="fa fa-home"></i> {{ admin_trans('home') }}</a></li>
