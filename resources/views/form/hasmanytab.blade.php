...
<div class="{{$viewClass['form-group']}} {!! !$errors->has($errorKey) ? '' : 'has-error' !!}">
    ...
    <div class="{{$viewClass['field']}} has-many-{{$column}}">
        ...
        <template class="nav-tab-tpl">
            <li class="new">
                <a href="#{{ $relationName . '_new_' . \Elegant\Admin\Form\NestedForm::DEFAULT_KEY_NAME }}" data-toggle="tab">
                    &nbsp;New {{ \Elegant\Admin\Form\NestedForm::DEFAULT_KEY_NAME }} <i class="fa fa-exclamation-circle text-red hide"></i>
                </a>
                <i class="close-tab fa fa-times" ></i>
            </li>
        </template>
        ...
        <template class="pane-tpl">
            <div class="fields-group tab-pane fields-group new" id="{{ $relationName . '_new_' . \Elegant\Admin\Form\NestedForm::DEFAULT_KEY_NAME }}">
                {!! $template !!}
            </div>
        </template>
    </div>
