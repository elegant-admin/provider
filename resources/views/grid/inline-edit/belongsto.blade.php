        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" style="border-radius: 5px;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">{{ admin_trans('choose') }}</h4>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">{{ admin_trans('cancel') }}</button>
                    <button type="button" class="btn btn-primary submit">{{ admin_trans('submit') }}</button>
                </div>
            </div>
        </div>
    </div>
...
@if($relation == \Elegant\Admin\Grid\Displayers\BelongsTo::class)
