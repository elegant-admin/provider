            ...
            <div class="select-options">
                <ul>
                    @foreach($selector['options'] as $value => $option)
                        ...
                        @endphp
                        <li>
                            <a href="{{ \Elegant\Admin\Grid\Tools\Selector::url($column, $value, true) }}" class="{{$active ? 'active' : ''}}">{{ $option }}</a>
                            @if(!$active && $selector['type'] == 'many')
                                &nbsp;
                                <a href="{{ \Elegant\Admin\Grid\Tools\Selector::url($column, $value) }}" class="add"><i class="fa fa-plus-square-o"></i></a>
                            @else
                    ...
                    @endforeach
                    <li>
                        <a href="{{ \Elegant\Admin\Grid\Tools\Selector::url($column) }}" class="clear"><i class="fa fa-trash"></i></a>
                    </li>
                </ul>
            </div>
        </div>
