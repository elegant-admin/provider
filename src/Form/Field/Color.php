...
class Color extends Text
{
    protected static $css = [
        '/vendor/elegant-admin/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.css',
    ];

    protected static $js = [
        '/vendor/elegant-admin/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.js',
    ];
