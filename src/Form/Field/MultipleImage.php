...
class MultipleImage extends MultipleFile
{
    ...
    protected function prepareForeach(UploadedFile $image = null)
    {
        ...
        /* Copied from single image prepare section and made necessary changes so the return value is same as before, but now thumbnails are saved to the disk as well. */
