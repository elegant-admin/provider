...
trait HasAssets
{
     ...
     * @var string
     */
    public static $manifest = 'vendor/elegant-admin/minify-manifest.json';
     ...
     */
    public static $min = [
        'js'  => 'vendor/elegant-admin/laravel-admin.min.js',
        'css' => 'vendor/elegant-admin/laravel-admin.min.css',
    ];
    ...
    public static $baseCss = [
        'vendor/elegant-admin/AdminLTE/bootstrap/css/bootstrap.min.css',
        'vendor/elegant-admin/font-awesome/css/font-awesome.min.css',
        'vendor/elegant-admin/laravel-admin/laravel-admin.css',
        'vendor/elegant-admin/nprogress/nprogress.css',
        'vendor/elegant-admin/sweetalert2/dist/sweetalert2.css',
        'vendor/elegant-admin/nestable/nestable.css',
        'vendor/elegant-admin/toastr/build/toastr.min.css',
        'vendor/elegant-admin/bootstrap3-editable/css/bootstrap-editable.css',
        'vendor/elegant-admin/google-fonts/fonts.css',
        'vendor/elegant-admin/AdminLTE/dist/css/AdminLTE.min.css',
    ];
    ...
    public static $baseJs = [
        'vendor/elegant-admin/AdminLTE/bootstrap/js/bootstrap.min.js',
        'vendor/elegant-admin/AdminLTE/plugins/slimScroll/jquery.slimscroll.min.js',
        'vendor/elegant-admin/AdminLTE/dist/js/app.min.js',
        'vendor/elegant-admin/jquery-pjax/jquery.pjax.js',
        'vendor/elegant-admin/nprogress/nprogress.js',
        'vendor/elegant-admin/nestable/jquery.nestable.js',
        'vendor/elegant-admin/toastr/build/toastr.min.js',
        'vendor/elegant-admin/bootstrap3-editable/js/bootstrap-editable.min.js',
        'vendor/elegant-admin/sweetalert2/dist/sweetalert2.min.js',
        'vendor/elegant-admin/laravel-admin/laravel-admin.js',
    ];
    ...
    public static $jQuery = [
        'vendor/elegant-admin/AdminLTE/plugins/jQuery/jQuery-2.1.4.min.js',
        'vendor/elegant-admin/jquery-cookie/jquery.cookie.js',
        'vendor/elegant-admin/jquery-ui/jquery-ui.min.js',
    ];
    ...
    public static function baseCss($css = null, $minify = true)
    {
        ...
        array_unshift(static::$baseCss, "vendor/elegant-admin/AdminLTE/dist/css/skins/{$skin}.min.css");
