...
class ExportSeedCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Export seed a Elegat-Admin database tables auth_menus, auth_roles and auth_users';
    ...
    public function handle()
    {
        ...
        if ($exportUsers) {
            $replaces = array_merge($replaces, [
                ...
                'TableRoleUsers'        => config('admin.database.user_roles_table'),
                ...
                'ArrayPivotRoleUsers'        => $this->getTableDataArrayAsString(config('admin.database.user_roles_table'), $exceptFields),
