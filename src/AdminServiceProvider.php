...
class AdminServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Blade::directive('box', function ($title) {
            return "<?php \$box = new \Elegant\Admin\Widgets\Box({$title}, '";
        });
    ...
    protected function registerPublishing()
    {
        if ($this->app->runningInConsole()) {
            $this->publishes([__DIR__.'/../config' => config_path()], 'elegant-admin-config');
            $this->publishes([__DIR__.'/../resources/lang' => resource_path('lang')], 'elegant-admin-lang');
            $this->publishes([__DIR__.'/../database/migrations' => database_path('migrations')], 'elegant-admin-migrations');
            $this->publishes([__DIR__.'/../resources/assets' => public_path('vendor/elegant-admin')], 'elegant-admin-assets');
        }
    }
